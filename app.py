...
def loanSubmit():
	...
	for i in range(1, 9):
		...
		repeatedIndividualLoanData[f'Individual {i} Home Street Address'] = request.form.get(f'individualHomeStreetAddress{i}', '!#$')
	...
	for i in range(1, 9):
		...
		repeatedUboLoanData[f'Ubo {i} Home Street Address'] = request.form.get(f'uboHomeStreetAddress{i}', '!#$')
	...
	for i in range(1, 9):
		...
		repeatedDirectorLoanData[f'Director {i} Home Street Address'] = request.form.get(f'directorHomeStreetAddress{i}', '!#$')
...
def investorSubmit():
	...
	investorData['Collateral'] = request.form.getlist('collateralInfo')
	investorData['Collateral (other)'] = request.form.get('otherCollateralText', '!#$')
	investorData['Collateral Specifications'] = request.form.get('collateralSpec')
	investorData['Collateral Value'] = request.form.get('collateralValue')
	investorData['Escrow Agent'] = request.form.get('escrowAgent')
	investorData['Vault Info'] = request.form.get('vaultInfo')
	investorData['Security Received'] = request.form.getlist('securityReceivedCheckbox')
	investorData['Security Guaranteed'] = request.form.getlist('securityGuaranteedCheckbox')
	investorData['Security Received Date'] = request.form.get('secRecDate')
	investorData['Origination Fee (points)'] = request.form.get('orgFeePoints')
	investorData['Origination Fee (USD)'] = request.form.get('orgFeeUSD')
	investorData['Agree Origination Fee'] = request.form.get('agreeOrgFee')
	investorData['Interest Rate'] = request.form.get('interestRate')
	investorData['APR'] = request.form.get('apr')
	investorData['Agree APR'] = request.form.get('agreeAPR')
	# investorData['Interest'] = request.form.get('interestDropdown') uncomment when we unlock interestDropdown
	investorData['Interest'] = 'N/A'
	investorData['Agree Interest'] = request.form.get('agreeInterestOnly')
	# investorData['Interest Payment'] = request.form.get('interestPaymentDropdown') uncomment when we unlock interestPaymentDropdown
	investorData['Interest Payment'] = 'On-Maturity'
	investorData['Agree Interest Due'] = request.form.get('agreeInterestDue')
	investorData['Investor Term'] = request.form.get('investorTerm')
	investorData['Agree Investor Term'] = request.form.get('agreeInvestorTerm')
	investorData['Investor Proceeds'] = request.form.get('investorProceeds')
	investorData['Agree Investor Proceeds'] = request.form.get('agreeInvestorProceeds')
	investorData['Bank Fees'] = request.form.get('bankFees')
	investorData['Agree Bank Fees'] = request.form.get('agreeBankFees')
	investorData['Disbursed Total'] = request.form.get('disbursedTotal')
	investorData['Agree Disbursed Total'] = request.form.get('agreeDisbursedTotal')
	investorData['Borrower is an'] = request.form.get('borrowerDropdown')
	...
	for i in range(1, 9):
		...
		repeatedIndividualInvestorData[f'Individual {i} Home Street Address'] = request.form.get(f'individualHomeStreetAddress{i}', '!#$')
		...
		repeatedIndividualInvestorData[f'Individual {i} Own or Rent'] = request.form.get(f'individualOwnRentDropdown{i}', '!#$')
		repeatedIndividualInvestorData[f'Individual {i} Monthly Mortgage/Rent'] = request.form.get(f'individualMonthlyRent{i}', '!#$')
		...
		repeatedIndividualInvestorData[f'Individual {i} Income'] = request.form.get(f'individualIncome{i}', '!#$')
	...
	for i in range(1, 9):
		...
		repeatedUboInvestorData[f'Ubo {i} Home Street Address'] = request.form.get(f'uboHomeStreetAddress{i}', '!#$')
		...
		repeatedUboInvestorData[f'Ubo {i} Own or Rent'] = request.form.get(f'uboOwnRentDropdown{i}', '!#$')
		repeatedUboInvestorData[f'Ubo {i} Monthly Mortgage/Rent'] = request.form.get(f'uboMonthlyRent{i}', '!#$')
		...
		repeatedUboInvestorData[f'Ubo {i} Income'] = request.form.get(f'uboIncome{i}', '!#$')
	...
	for i in range(1, 9):
		...
		repeatedDirectorInvestorData[f'Director {i} Home Street Address'] = request.form.get(f'directorHomeStreetAddress{i}', '!#$')
		...
		repeatedDirectorInvestorData[f'Director {i} Own or Rent'] = request.form.get(f'directorOwnRentDropdown{i}', '!#$')
		repeatedDirectorInvestorData[f'Director {i} Monthly Mortgage/Rent'] = request.form.get(f'directorMonthlyRent{i}', '!#$')
		...
		repeatedDirectorInvestorData[f'Director {i} Income'] = request.form.get(f'directorIncome{i}', '!#$')
